                            ...
                            <tr>
                                ...
                                <td class="px-3 py-3">
                                    <textarea name="catatan[{{ $siswa->id }}]" rows="2" placeholder="Catatan singkat dari wali kelas"
                                        class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-900">{{ old('catatan.' . $siswa->id, $val) }}</textarea>
                                </td>
                            </tr>
                        @empty
                            <tr>
